...
const CakeCard = ({title, img, id}) => {

     return(
      <div>
        
        <div className="w-[15vw] h-[400px] mt-[15vh] bg-gray-200 flex flex-col items-stretch">    
            <img className="w-[100%] h-[55%] object-cover object-center" src={"https://apipics.s3.amazonaws.com/cakes_api/" +id+".jpg"}/>
            <h1 className="font-bold text-lg pt-3 pb-5 px-1 leading-tight">{title}</h1>

            <Link to={"/recipe/"+id}>
                <button className=" bg-sky-300 px-6 py-3 text-white relative overflow-hidden z-30 group hover:bg-sky-800 transition-all duration-500 rounded tracking-wider font-semibold ml-7">
                  Get Recipe
                  <svg className="absolute inset-0 left-0 top-0 fill-sky-300 -z-30 opacity-0 group-hover:opacity-100 group-hover:duration-300 group-hover:transition-all group-active:fill-sky-950"
                  ...
                  >
                  <path d="M850 1069 c-23 -48 -27 -66 -19 -85 5 -14 9 -40 9 -57 0 -18 4 -38 9
                    -46 9 -14 19 36 19 99 1 44 7 71 17 78 9 6 35 56 35 67 0 3 -9 5 -20 5 -15 0 -28 -16 -50 -61z"></path>
                  ...
                  <path d="M8 875 c6 -11 22 -33 36 -49 27 -30 33 -60 16 -71 -6 -4 -19 -24 -30 -45 l-20 -39 43 -32 c23 -18 43 -34 45 -34 1 -1 4 -60 7 -131 4 -121 6 -130 30 -153 19 -20 25 -22 25 -9 0 8 -7 21 -15 28 -14 12 -15 23 -14 177 1 8 -13
                    116 -66 129 -29 7 -35 44 -10 64 8 7 15 19 15 27 0 7 6 16 14 19 27 10 -11 78 -68 124 -18 14 -18 14 -8 -5z"></path>
